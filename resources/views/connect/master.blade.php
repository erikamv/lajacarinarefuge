<!--Plantilla maestra para login y registro-->
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <link href="{{asset("/static/css/bootstrapConnect.css")}}" rel="stylesheet">
        <link href=@yield('href') rel="stylesheet">
    ...
    <body>
      ...
      <header id="header">
        <nav class="navbar navbar-expand-lg navbar-light">
          <a class="logo" href="#" style="padding-left: 8%;">
            <img src="/static/imagenes/logoJacarina.png" class="d-inline-block align-top" alt="logo-jacarina">
          </a>
