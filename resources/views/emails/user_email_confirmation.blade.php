...
<p><h4><a href="{{url('/confirmation?email='.$email.'/'.$confirmation_code)}}" style="display: inline-block; background-color: #6c6874; color: #fff; padding:12px;
...
<p>{{url('/confirmation?email='.$email.'/'.$confirmation_code)}}</p>
